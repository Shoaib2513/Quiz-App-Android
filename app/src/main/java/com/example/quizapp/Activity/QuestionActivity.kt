...
class QuestionActivity : AppCompatActivity(), QuestionAdapter.score {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        receivedList =
            intent.getParcelableArrayListExtra<QuestionModel>("list")!!.toMutableList()
        ...
        binding.apply {
            ...
            questionNumberTxt.text = "Question 1/10"
            ...
            rightArrow.setOnClickListener {
                ...
                if (progressBar.progress == 10) {
                    val intent =
                        Intent(this@QuestionActivity, ScoreActivity::class.java)
                ...
                questionNumberTxt.text =
                    "Question " + progressBar.progress + "/10"
                questionTxt.text = receivedList[position].question
