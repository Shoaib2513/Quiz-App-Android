...
class MainActivity : AppCompatActivity() {
    ...
    private fun questionList(): MutableList<QuestionModel> {
        ...
        question.add(
            QuestionModel(
                3,
                "Which of the following substance is used as an anti-color medication in the medical world?",
                "Cheese",
                "Lemon",
                "Cannabis",
                "Paspalum",
        ...
        question.add(
            QuestionModel(
                4,
                "Which moon is the Earth' solar system has an atmosphere",
                "Luna (Moon)",
                "Phobos (Mars' moon)",
                "Venus' moon",
                "None of above",
